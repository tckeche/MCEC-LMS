...
import { ArrowLeft, LogIn, AlertCircle, Loader2, Briefcase } from "lucide-react";
          ...
          <PageTransition>
            <GlassCard className="w-full max-w-md">
              <GlassCardHeader className="text-center">
                <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-xl bg-primary/10 text-primary ring-1 ring-primary/20">
                  <Briefcase className="h-7 w-7" />
                </div>
                <GlassCardTitle className="text-xl" data-testid="text-sso-required-title">
                  Staff Login
                </GlassCardTitle>
                <GlassCardDescription data-testid="text-sso-required-description">
