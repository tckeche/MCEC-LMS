    ...
    <div className="mx-auto max-w-7xl px-4 py-6 md:px-8 md:py-8">
      <div className="mb-8">
        ...
        <p className="mt-1 text-muted-foreground">
          Manage and view all courses across the platform.
        </p>
      </div>
        ...
        {isLoading ? (
          ...
          <>
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="flex items-center gap-4">
                  <div className="flex h-10 w-10 items-center justify-center rounded-md bg-green-500/10 dark:bg-green-500/20">
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="flex items-center gap-4">
                  <div className="flex h-10 w-10 items-center justify-center rounded-md bg-yellow-500/10 dark:bg-yellow-500/20">
